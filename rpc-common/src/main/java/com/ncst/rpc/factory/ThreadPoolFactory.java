...
public class ThreadPoolFactory {
     ...
     * 线程池参数
     */
    private static final int CORE_POOL_SIZE = 10;//核心线程
    private static final int MAXIMUM_POOL_SIZE_SIZE = 100;//最大
    private static final int KEEP_ALIVE_TIME = 1;//保持连接
    private static final int BLOCKING_QUEUE_CAPACITY = 100;//阻塞队列大小
